                ...
                <div className="pt16 pb16 o_colored_level col-lg-4 border rounded shadow o_we_force_no_transition center-box" style={{ borderWidth: "1px !important", borderRadius: "5px !important", borderColor: "rgb(206, 212, 218) !important", boxShadow: "rgb(206, 212, 218) 2px 2px 7px 1px !important" }}>
                    <div className="s_card card w-100 o_we_force_no_transition" data-name="Card">
                        <div className="card-body" title="Dịch vụ giặt sấy lấy liền">
                            ...
                            <p style={{ textAlign: "center" }}>
                                <a className="btn btn-custom text-white btn-sm" href="/dich-vu-giat-say" title="Xem chi tiết dịch vụ giặt sấy lấy liền" style={{ borderWidth: "0px", borderStyle: "solid", backgroundImage: "linear-gradient(135deg, rgb(203, 94, 238) 0%, rgb(75, 225, 236) 100%)" }}><span className="fa fa-long-arrow-right" title="Chi tiết dịch vụ giặt sấy của Giặt ủi 247" aria-describedby="tooltip902191" style={{ padding: "2px !important" }}></span>Chi tiết dịch vụ giặt sấy lấy liền</a>
                            </p>
                        </div>
                    </div>
                    <div className="s_card card w-100 o_we_force_no_transition" data-name="Card">
